...
#SBATCH --array=1-2 
#At the moment there seems to be an ASF bottleneck if you submit more than 180 jobs through the array line above. 
...
# Here the program reads from two separate lists of SLCs generated by the refmake.py script. 
